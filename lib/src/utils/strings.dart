const baseUrl = "https://myevent.tbg.cm";
const appName = "MyEvent";
const welcome = "Bienvenue";
const to = "Sur";
const loginFailed = "Echec!!!verifiez vos paramètres ou vos mails";
const loginSuccess = "Connexion reussie";
...
const invalidMatricule = "Matricule Invalide";
